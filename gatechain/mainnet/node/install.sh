...
# File Download URLs
GH_REPO_URL="https://media.githubusercontent.com/media/gatechain/node-binary/master/gatechain/mainnet/node/${BIN_VERSION}"
...
FULLNODE_CONFIG_URL="https://raw.githubusercontent.com/gatechain/node-binary/master/gatechain/mainnet/node/${BIN_VERSION}/config"
